...
class PRN:
    ...
    def __init__(self, is_dlib=False, prefix='.'):
        ...
        if is_dlib:
            ...
            detector_path = os.path.join(
                prefix, 'PRNet/Data/net-data/mmod_human_face_detector.dat')
        ...
        prn_path = os.path.join(
            prefix, 'PRNet/Data/net-data/256_256_resfcn256_weight')
        ...
        self.triangles = np.loadtxt(
            prefix + '/PRNet/Data/uv-data/triangles.txt').astype(np.int32)  # ntri x 3
    ...
    def process(self, input, image_info=None):
        ...
        if image_info is not None:
            ...
            # only use the first detected face (assume that each input image
